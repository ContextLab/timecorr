...
latex_documents = [
  ('index', 'timecorr.tex', u'timecorr Documentation',
...
texinfo_documents = [
  ('index', 'timecorr', u'timecorr Documentation',
   u'Contextual Dynamics Laboratory', 'timecorr', 'Compute moment-by-moment correlations from a timeseries of observations.',
   'Statistics'),
]
