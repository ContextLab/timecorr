...
job_commands = map(lambda x: x[0]+" "+str(x[1])+" "+str(x[2]), zip([job_script]*600,['../../pieman-paragraph/']*100+['../../pieman-resting/']*100+['../../pieman-intact/']*100+['../../pieman-word/']*100+['../../sherlock/']*100+['../../forrest/']*100,range(100)*6))
